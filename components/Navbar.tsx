  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-white/10 glass">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-8 text-xs font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-500">
        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          <button className="hidden sm:block text-sm font-semibold text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">Log in</button>
          <a href="#signup" className="bg-zinc-900 dark:bg-white text-white dark:text-black text-xs sm:text-sm font-bold px-4 sm:px-6 py-2 rounded-full hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all active:scale-95 shadow-lg">
            Get Started
          </a>
        </div>
      </div>
