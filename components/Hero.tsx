    ...
    <section className="relative pt-12 pb-16 md:pt-24 md:pb-32 overflow-hidden">
      <div className="container mx-auto px-4 text-center">
        {isGithubConnected ? (
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-green-500/20 bg-green-500/5 text-green-700 dark:text-green-400 text-xs font-bold mb-8 animate-in fade-in duration-700 shadow-sm">
            <span className="relative flex h-2 w-2">
